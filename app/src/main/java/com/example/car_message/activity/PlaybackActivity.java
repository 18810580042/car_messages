...
import com.example.car_message.markerutil.PointsUtil;
import com.example.car_message.markerutil.SmoothMarker;
...
public class PlaybackActivity extends BaseActivity {
    ...
    protected void initView(Bundle savedInstanceState) {
        map_playback = findViewById(R.id.map_playback);
        map_playback.onCreate(savedInstanceState);
        ...
        SetImageBack();//设置tal  属性
        if (map == null) {
            map = map_playback.getMap();
    ...
    private void movecar() {
        ...
        smoothMarker = new SmoothMarker(map);
        ...
        smoothMarker.setMoveListener(new SmoothMarker.SmoothMarkerMoveListener() {
            ...
            @Override
            public void stop() {
                Toast.makeText(PlaybackActivity.this, "动画停止", Toast.LENGTH_SHORT).show();
                Log.d("PlaybackActivity", smoothMarker.getPosition().toString());
            }
    ...
    private View getInfoWindowView(Marker marker) {
        if (infoWindowLayout == null) {
            infoWindowLayout = new LinearLayout(PlaybackActivity.this);
            infoWindowLayout.setOrientation(LinearLayout.VERTICAL);
            title = new TextView(PlaybackActivity.this);
            snippet = new TextView(PlaybackActivity.this);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        map_playback.onSaveInstanceState(outState);
    }
    ...
    private void addPolylineInPlayGround() {
        ...
        map.addPolyline(new PolylineOptions().setCustomTexture(BitmapDescriptorFactory
