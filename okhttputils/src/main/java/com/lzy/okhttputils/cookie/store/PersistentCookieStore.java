...
public class PersistentCookieStore implements CookieStore {
    ...
    private SaveCookieInterceptor saveCookieInterceptor;

    public PersistentCookieStore setSaveCookieInterceptor(SaveCookieInterceptor saveCookieInterceptor) {
        this.saveCookieInterceptor = saveCookieInterceptor;
        return this;
    }
    ...
    public void saveCookies(HttpUrl url, List<Cookie> urlCookies) {
        ...
        for (Cookie cookie : urlCookies) {
            // 先注释，未登录时忘记密码认证短信时会报验证码错误
//            if (saveCookieInterceptor.removeFillter(url,cookie)) {
//                removeCookie(url, cookie);
//                continue;
//            }
            //当前cookie是否过期
    ...
    public interface SaveCookieInterceptor {
        boolean removeFillter(HttpUrl url, Cookie cookie);
    }
