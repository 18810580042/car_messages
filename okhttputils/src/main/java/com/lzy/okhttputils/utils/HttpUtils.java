...
//                String headerValue = URLEncoder.encode(entry.getValue(), "UTF-8");
    ...
    /** 生成类似表单的请求体 */
    public static RequestBody generateMultipartRequestBody(HttpParams params,boolean isForceMultipartBody) {
        if (params.fileParamsMap.isEmpty()&&!isForceMultipartBody) {
            //表单提交，没有文件
